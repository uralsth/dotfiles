...
-- beautiful.wallpaper = gears.filesystem.get_configuration_dir() .. "~/Pictures/Rick.jpg"
...
awful.spawn.with_shell("xautolock -time 15 -locker slock")
...
--       awful.spawn(terminal.." -e nm-applet")
--    end
-- end
